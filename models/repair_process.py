...
class RepairComponentProcess(models.Model):
    ...
    component_type_filter = fields.Selection(
        selection=[
            ('camisa', 'Camisa'),
            ('haste_tubular', 'Haste Tubular'),
            ('eixo_haste', 'Eixo da Haste'),
            ('cabecote_diant_sec', 'Cabecote Diant. Secundario'),
            ('cabecote_diant_pri', 'Cabecote Diant. Primario'),
            ('cabecote_traseiro', 'Cabecote Traseiro'),
            ...
            ('flange', 'Flange'),
            ('embolo', 'Embolo'),
            ('bloco_valvula', 'Bloco de Valvula'),
            ('motor_hidraulico', 'Motor Hidraulico'),
            ('carro', 'Carro'),
            ('todos', 'Todos'),
            ('outro', 'Outro'),
        ],
